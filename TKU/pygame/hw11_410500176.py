...
#========================================滑鼠事件:開始畫面========================================
    ...
    if wait == 1:
        ...
        if (mouse_x > 340 and mouse_x < 460) and (mouse_y > 250 and mouse_y < 300):
            text2 = font2.render("start", True, color_dic['B'], light_GREY)
            gameDisplay.blit(text2, (340,250))

        else:   
            text3 = font2.render("start", True, color_dic['B'], WHITE)
